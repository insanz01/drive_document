    ...
    <div class="col-lg-12">
      ...
      <div class="card mb-4">
        <div class="card-header">
          Form Edit Daftar Surat
        </div>
        <div class="card-body">
          <form action="<?= base_url('Berkas/ubah_daftar_surat/') . $id ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="perihal" class="form-control" id="perihal" value="<?= $isi['perihal'] ?>">
            </div>
            <div class="form-group">
